    ...
    <Dialog open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogContent className="max-w-4xl w-[90vw] max-h-[90vh] flex flex-col" style={{ 
        ...
        <div className="flex-1 overflow-auto my-4 p-4 rounded" style={{ backgroundColor: 'var(--bg-card-hover)' }}>
          {/* Document content */}
          <div className="bg-white rounded shadow-lg p-8 min-h-[60vh] flex flex-col">
            {/* Mock document content */}
            <div className="text-center mb-4 text-gray-500 text-sm">Page {currentPage} of {totalPages}</div>
        ...
        <div className="flex justify-between items-center mt-2">
          <Button
            ...
            style={{
              borderColor: 'var(--border-dark)',
              color: currentPage === 1 ? 'var(--text-muted-darker)' : 'var(--text-muted)',
          ...
          <Button
            ...
            style={{
              borderColor: 'var(--border-dark)',
              color: currentPage === totalPages ? 'var(--text-muted-darker)' : 'var(--text-muted)',
